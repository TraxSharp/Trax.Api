...
/// <summary>
/// Emits a one-shot warning on startup whenever Trax API-key auth is wired up.
...
/// </summary>
internal sealed class TraxApiKeyAuthDisclaimerHostedService(ILoggerFactory loggerFactory)
    : IHostedService
{
    ...
    {
        var logger = loggerFactory.CreateLogger("Trax.Api.Auth.ApiKey");
